...
import { Loader2, Eye, AlertTriangle, Phone, Bell, ArrowLeft, CheckCircle, AlertCircle, Clock } from 'lucide-react';
      ...
      {filteredContracts.length === 0 ? (
        ...
        <div className="space-y-4">
          {filteredContracts.map((contract) => {
            ...
            return (
              <Card key={contract.id} className={`${severity.bgColor} border transition-colors`}>
